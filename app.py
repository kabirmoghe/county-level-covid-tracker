...
def about():
	...
	static = os.listdir('/users/kabirmoghe/Desktop/covidapp/static')
	[os.remove('/users/kabirmoghe/Desktop/covidapp/static/{}'.format(file)) for file in static if file == 'nationwideavg.png']
